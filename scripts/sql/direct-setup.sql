...
CREATE TABLE IF NOT EXISTS tours (
  ...
  is_flexible_duration BOOLEAN DEFAULT FALSE,
  ...
  code TEXT,
  max_travelers INTEGER DEFAULT 0,
  languages TEXT,
  ...
  unlimited_reschedule BOOLEAN DEFAULT FALSE,
...
CREATE INDEX IF NOT EXISTS idx_tours_airtable_id ON tours(airtable_id);
